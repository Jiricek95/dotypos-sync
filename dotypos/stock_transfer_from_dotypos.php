...
$request_url = 'https://api.dotykacka.cz/v2/clouds/'.$access_token_data['cloudid'].'/warehouses/'.$access_token_data['warehouse_id'].'/products?page=1&limit=100&filter=deleted%7Ceq%7Cfalse';
